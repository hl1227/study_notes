...
Schedule = AsyncIOScheduler(
    jobstores={
        'default': SQLAlchemyJobStore(url=f'mysql+pymysql://root:66884747@127.0.0.1:3306/caijiqi_test?charset=utf8')
    }
)
Schedule.start()
...
#     uvicorn.run(app='run2:app', host="127.0.0.1", port=8151, reload=False, debug=True)
