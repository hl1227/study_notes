...
class Settings(BaseSettings):
    ...
    SQLALCHEMY_DATABASE_URI: str =f'mysql+pymysql://root:66884747@127.0.0.1:3306/fastapi_blog?charset=utf8' #f'sqlite:///{BASEDIR}/fastapi-vue-blog.db'
    # SQLALCHEMY_DATABASE_URI: str =f'pymysql://root:66884747@127.0.0.1:3306/fastapi_blog?charset=utf8' #f'sqlite:///{BASEDIR}/fastapi-vue-blog.db'
